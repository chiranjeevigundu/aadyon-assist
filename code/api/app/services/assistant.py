...
def _system_prompt() -> str:
    ...
    return (
        ...
        "progress_pct of open milestones (a goal you set on the profile is auto-mirrored into a "
        "milestone at 0%), and Career scores job applications + current_income vs target_salary. "
        "When the user reports progress toward a goal, update the matching milestone's progress_pct; "
        "if a score looks low, explain which data would move it. "
